def add_options(parser):
    # fmt: off
    # Dataset
    parser.add_argument("--train-data-file", default="cs-cs.var.tok.txt", help="training data")
    ...
    parser.add_argument("--sp-model", default="microsoft/codebert-base-mlm", help="SP model to load for evaluation")
